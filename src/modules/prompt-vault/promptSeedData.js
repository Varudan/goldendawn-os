export const PROMPT_SEED_DATA = Object.freeze([
  Object.freeze({
    id: 'prompt-learning-explain-001',
    title: 'Lernstoff verständlich erklären',
    description:
      'Ein synthetischer Beispielprompt für klar strukturierte Lernerklärungen.',
    category: 'Lernen',
    content:
  ...
  Object.freeze({
    id: 'prompt-automation-plan-001',
    title: 'KI-Automatisierung planen',
    description:
      'Ein synthetischer Beispielprompt zur sicheren Planung einer Automatisierung.',
  ...
  Object.freeze({
    id: 'prompt-weekly-reflection-001',
    title: 'Wöchentliche Reflexion',
    description:
      'Ein synthetischer Beispielprompt für einen ruhigen, strukturierten Wochenrückblick.',
    category: 'Reflexion',
    content:
